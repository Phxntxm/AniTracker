...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        sizePolicy.setHeightForWidth(
            self.AnimeFolderLineEdit.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setHeightForWidth(
            self.AnimeFolderBrowse.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setHeightForWidth(
            self.AnimeFolderSettingsLabel.sizePolicy().hasHeightForWidth()
        )
        self.AnimeFolderSettingsLabel.setSizePolicy(sizePolicy)
        self.SubtitleLanguageSettingsLabel = QLabel(self.GeneralSettingsTab)
        self.SubtitleLanguageSettingsLabel.setObjectName(
            u"SubtitleLanguageSettingsLabel"
        )
        self.SubtitleLanguageSettingsLabel.setGeometry(QRect(10, 40, 121, 16))
        sizePolicy.setHeightForWidth(
            self.SubtitleLanguageSettingsLabel.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy1.setHeightForWidth(
            self.AnilistCodeBox.sizePolicy().hasHeightForWidth()
        )
    ...
    def retranslateUi(self, Settings):
        ...
        self.AnimeFolderBrowse.setText(
            QCoreApplication.translate("Settings", u"Browse", None)
        )
        self.AnimeFolderSettingsLabel.setText(
            QCoreApplication.translate("Settings", u"Anime Folder:", None)
        )
        self.SubtitleLanguageSettingsLabel.setText(
            QCoreApplication.translate("Settings", u"Subtitle Language:", None)
        )
        self.IgnoreSongsSignsCheckbox.setText(
            QCoreApplication.translate(
                "Settings", u"Ignore Songs and Signs Subtitles", None
            )
        )
        self.SettingsTabWidget.setTabText(
            self.SettingsTabWidget.indexOf(self.GeneralSettingsTab),
            QCoreApplication.translate("Settings", u"General", None),
        )
        self.AnilistInstructionsLabel.setText(
            QCoreApplication.translate(
                "Settings",
                u"To connect to anilist click connect to the left, authenticate, and provide the code below. Then click confirm code",
                None,
            )
        )
        self.AnilistConnectedAccountLabel.setText(
            QCoreApplication.translate("Settings", u"Connected account: N/A", None)
        )
        self.AnilistConnect.setText(
            QCoreApplication.translate("Settings", u"Connect to anilist", None)
        )
        self.AnilistCodeConfirm.setText(
            QCoreApplication.translate("Settings", u"Confirm Code", None)
        )
        self.SettingsTabWidget.setTabText(
            self.SettingsTabWidget.indexOf(self.AnilistSettingsTab),
            QCoreApplication.translate("Settings", u"Anilist", None),
        )
